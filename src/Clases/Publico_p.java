...
public class Publico_p extends Persona {
    ...
    public String toString() {
        return "Publico_p{" + "codigo_publico=" + codigo_publico + ", preferencias_p=" + preferencias_p + ", contrase\u00f1a=" + contraseña + ", codigo_encuesta=" + codigo_encuesta + ", codigo_cali_even=" + codigo_cali_even + ", cedula_persona=" + cedula_persona + '}';
    }
