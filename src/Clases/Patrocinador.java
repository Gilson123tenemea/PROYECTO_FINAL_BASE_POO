...
public class Patrocinador extends Persona{
    private int codigo_patri;//llave primaria
    ...
    public Patrocinador(int codigo_patri, String Descripcion_p, String redes_sociales, String cedula, String nombre, String apellido, String telefono, String correo, String direccion, String celular, Date fecchaNaci, String genero) {
    ...
    public int getCodigo_patri() {
        return codigo_patri;
    }

    public void setCodigo_patri(int codigo_patri) {
        this.codigo_patri = codigo_patri;
    }
